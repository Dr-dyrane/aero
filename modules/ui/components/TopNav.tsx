...
export function TopNav({ title, onBack, scrollSensitivity = true }: TopNavProps) {
    ...
    const content = {
        en: {
            ...
            vitalBaseline: "Bio-Status",
            optimal: "Optimal",
            bioConnectivity: "Connectivity",
            vaultInsurance: "Vault Status",
            active: "ACTIVE",
        ...
        ar: {
            ...
            vitalBaseline: "حالة الجسم",
            optimal: "مثالي",
            bioConnectivity: "الاتصال",
            vaultInsurance: "حالة الخزنة",
            active: "نشط",
            navigation: "التنقل",
            dashboard: "لوحة التحكم",
            bioVault: "الخزنة الحيوية",
            identity: "الإعدادات",
            diagnostics: "الفحص",
            sovereign: "بروتوكول الهوية",
            howItWorks: "كيف يعمل أيرو",
