export default function VaultLoading() {
  return (
    <main className="flex min-h-screen flex-col items-center p-2 pb-24">
      ...
      <div className="h-36 w-full max-w-sm animate-pulse rounded-3xl bg-[rgba(255,255,255,0.1)] backdrop-blur-sm" />
      <div className="mt-4 flex w-full max-w-sm gap-3">
        <div className="h-24 flex-1 animate-pulse rounded-3xl bg-[rgba(255,255,255,0.1)] backdrop-blur-sm" />
        <div className="h-24 flex-1 animate-pulse rounded-3xl bg-[rgba(255,255,255,0.1)] backdrop-blur-sm" />
      </div>
